          ...
          <div className="max-w-4xl mx-auto animate-fade-in space-y-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow border border-slate-200">
              <p className="text-lg text-slate-700 mb-6">
                Situé au cœur de Pexiora dans l'Aude, l'<strong>Union Bouliste de Pexiora (UBP)</strong> rassemble les passionnés de pétanque dans une ambiance conviviale et sportive.
              </p>
